...
class RSATestCase(unittest.TestCase):
    ...
    def test_egcd(self):
        self.assertEqual((1, 3, -17), rsa.egcd(7, 40))
        self.assertEqual((1, 1, -48), rsa.egcd(42, 2017))
        self.assertEqual((1, 0, 1), rsa.egcd(40, 1))
        self.assertEqual((1, 50, -119), rsa.egcd(121, 288))
        self.assertEqual((1, -61659, 734969), rsa.egcd(142169, 1694640))
        self.assertEqual((1, -1562026, 1804547), rsa.egcd(9678731, 11181456))
